...
UNREAL5_EDU_API UClass* Z_Construct_UClass_AMyPlayer_NoRegister();
...
{
	struct MyAnimInstance_eventJumpToSection_Parms
	{
		int32 sectionIndex;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::NewProp_sectionIndex = { "sectionIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyAnimInstance_eventJumpToSection_Parms, sectionIndex), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::NewProp_sectionIndex,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMyAnimInstance, nullptr, "JumpToSection", nullptr, nullptr, Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::MyAnimInstance_eventJumpToSection_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::MyAnimInstance_eventJumpToSection_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UMyAnimInstance_JumpToSection()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMyAnimInstance_JumpToSection_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UMyAnimInstance::execJumpToSection)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_sectionIndex);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->JumpToSection(Z_Param_sectionIndex);
	P_NATIVE_END;
}
// End Class UMyAnimInstance Function JumpToSection

// Begin Class UMyAnimInstance Function PlayAnimMontage_Attack
struct Z_Construct_UFunction_UMyAnimInstance_PlayAnimMontage_Attack_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MyAnimInstance.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMyAnimInstance_PlayAnimMontage_Attack_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMyAnimInstance, nullptr, "PlayAnimMontage_Attack", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMyAnimInstance_PlayAnimMontage_Attack_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMyAnimInstance_PlayAnimMontage_Attack_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UMyAnimInstance_PlayAnimMontage_Attack()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMyAnimInstance_PlayAnimMontage_Attack_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UMyAnimInstance::execPlayAnimMontage_Attack)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->PlayAnimMontage_Attack();
	P_NATIVE_END;
}
// End Class UMyAnimInstance Function PlayAnimMontage_Attack
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitHub_Unreal_2025_UnrealEngine5_Unreal5_edu_Source_Unreal5_edu_Public_MyAnimInstance_h_2312511607(TEXT("/Script/Unreal5_edu"),
